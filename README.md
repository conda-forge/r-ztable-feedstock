...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1822&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ztable-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ztable` can be installed with `conda`:
...
```
mamba install r-ztable
```

It is possible to list all of the versions of `r-ztable` available on your platform with `conda`:
...
```
mamba search r-ztable --channel conda-forge
```
...
mamba repoquery search r-ztable --channel conda-forge

# List packages depending on `r-ztable`:
mamba repoquery whoneeds r-ztable --channel conda-forge

# List dependencies of `r-ztable`:
mamba repoquery depends r-ztable --channel conda-forge
```
